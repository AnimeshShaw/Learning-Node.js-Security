# Node.js Security Reading Materials

## Articles

* [7 Tools to Scan Node.js Application for Security Vulnerability](https://geekflare.com/nodejs-security-scanner/)
* [Node.js Security Done Right](https://www.owasp.org/images/f/fa/AppSecIL2016_NodeJS-Security_LiranTal.pdf)
...
* [Code Assisted Penetration Testing of a NodeJS App](https://blog.securityinnovation.com/blog/2014/10/code-assisted-penetration-testing-of-a-nodejs-app.html#article)
* [Nodexp – A Server Side Javascript Injection Tool Capable Of Detecting & Exploiting Node.js Vulnerabilities](https://kalilinuxtutorials.com/nodexp/)
...
* [Securing Your Node.js App](https://stackabuse.com/securing-your-node-js-app/)
...
* [Code Review of Node.Js Applications: Uncommon Flaws](https://resources.infosecinstitute.com/penetration-testing-node-js-applications-part-2/)
* [Secure coding and penetration testing with Node.js](https://julianberton.com/assets/downloads/Node.js%20Security.pdf) 
* [Methodology — Secure Code Review for Node.JS Express Apps](https://medium.com/@hungry.soul/methodology-secure-code-review-for-node-js-express-apps-457d1281ca6d)

### Node.js General Articles - SecurityKnowHow 
...
* [nodejs-security-must-know](https://github.com/wahengchang/nodejs-security-must-know)
* [Documentation for Essential Node.js Security](https://github.com/lirantal/nodejssecurity)
* [nodebestpractices](https://github.com/i0natan/nodebestpractices)
* [nodexp](https://github.com/esmog/nodexp)

## Video Tutorials

--To be Updated--

## Practice (Vulnerable WebApps)
